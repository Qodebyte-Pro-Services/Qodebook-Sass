...
exports.createSale = async (req, res) => {
  try {
    ...
    for (const item of items) {
      ...
      await pool.query('INSERT INTO inventory_logs (variant_id, type, quantity, note, business_id, branch_id, recorded_by, recorded_by_type) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)', [item.variant_id, 'sale', item.quantity, 'Sale transaction', business_id, branch_id, req.user?.staff_id || req.user?.id, recorded_by_type]);
